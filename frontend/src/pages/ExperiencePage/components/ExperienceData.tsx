const ExperienceData = ()=> [
  {
    ...
    points: [
      ...
      'Led a diverse team of 4 developers, fostering collaboration and ensuring high productivity.',
      'Developed and implemented an access-based token system, reducing average login time from 2 minutes to 5 seconds.'
    ]
  }
];
